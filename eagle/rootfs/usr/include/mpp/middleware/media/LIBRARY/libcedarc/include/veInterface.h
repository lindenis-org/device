...
typedef struct VeOpsS
{
    ...
    void (*lockTop00Reg)(void*);
    void (*unLockTop00Reg)(void*);
}VeOpsS;
...
static inline void CdcVeLockTopReg00(VeOpsS *veops, void *p)
{
    return veops->lockTop00Reg(p);
}
static inline void CdcVeUnLockTopReg00(VeOpsS *veops, void *p)
{
    return veops->unLockTop00Reg(p);
}
