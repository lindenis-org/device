...
typedef struct RECRENDERDATATYPE {
    ...
    struct list_head mVideoInputFrameIdleList;  //VEncCompOutputBuffer
    ...
    struct list_head mAudioInputFrameIdleList;  //AEncCompOutputBuffer
    ...
    struct list_head mTextInputFrameIdleList;  //TEncCompOutputBuffer
